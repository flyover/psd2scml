...
function main() {
  ...
  (function() // generate objects
    {
      ...
      var findBoneByName = function(start_bone, bone_name) {
        return findBone(start_bone, function(bone) {
  ...
  /* scope */
  (function() // calculate bone angles
    {
  ...
  /* scope */
  (function() // generate Spine JSON skeleton
    {
      var json = {};
      json.skeleton = {};
      ...
      for (object_i = 0, object_ct = objects.length; object_i < object_ct; ++object_i) {
        ...
        if (object.bone) {
          bone_name = object.bone.name;
        }
        var slot_name = file.base_name; //bone_name;
        if (object.slot) {
          slot_name = object.slot.name;
        }
